# Descarga Automática Gmail → Google Drive V4
...
Los mensajes con la etiqueta de error se excluyen de ejecuciones posteriores.
Para reintentarlos, corrige la causa, elimina la etiqueta
